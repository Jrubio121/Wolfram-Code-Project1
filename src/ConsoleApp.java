// Worked on the ConsoleApp class with Keeton
...
public class ConsoleApp {
	...
	private void setRuleAndGeneration() {
		...
		Generation temp = new Generation(input.next(),'1');
		automaton = new Automaton(num,temp);
	...
	private void setTrueSymbol() {
		...
		automaton.trueSymbol = temp.charAt(0);
	}
	...
	private void setFalseSymbol() {
		...
		String temp = input.next();
		automaton.falseSymbol = temp.charAt(0);
	}
	...
	private void evolve() {
		...
		if(evolutions > 0) {
			...
			automaton.evolve(evolutions);
			System.out.println("Evolved " + evolutions + " generation(s)");
		}
		else {
			System.out.print("Enter number of evolutions > ");
			automaton.evolve(evolutions);
			System.out.println("Evolved " + "0" + " generation(s)");
		}
